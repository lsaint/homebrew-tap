class Aikito < Formula
  ...
  url "https://github.com/lsaint/aikito/archive/refs/tags/v1.25.1.tar.gz"
  sha256 "822ae965579c6d1d921d3872667051ca7bf1e952fd328561e75a4b0132822369"
  license "MIT"
  ...
  test do
    assert_match "aikito 1.25.1", shell_output("#{bin}/aikito --version")
